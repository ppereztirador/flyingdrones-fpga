...
namespace OV5640_cfg {
	...
	using mode_t = enum { MODE_720P_1280_720_60fps = 0, MODE_1080P_1920_1080_15fps,
		...
		MODE_1080P_1920_1080_30fps_336M_1LANE_MIPI, MODE_VGA_640_480_60fps, MODE_VGA_2, MODE_VGA_3, MODE_END } ;
...
config_word_t const cfg_1080p_30fps_336M_1lane_mipi_[] =
	...
	config_word_t const cfg_VGA_60fps_[] = // ** = THINGS THAT PABLO CHANGES
	...
	config_word_t const cfg_VGA_2_[] =
	{//1280 x 720 binned, RAW10, MIPISCLK=280M, SCLK=56Mz, PCLK=56M -> SCLK=168M
		//PLL1 configuration
		//[7:4]=0001 System clock divider /1, [3:0]=0001 Scale divider for MIPI /1
		{0x3035, 0x11},
		//[7:0]=105 PLL multiplier
	...
	config_word_t const cfg_VGA_3_[] =
	{//640x480 binned
		//PLL1 configuration
		//[7:4]=0001 System clock divider /4, [3:0]=0001 Scale divider for MIPI /1
		{0x3035, 0x41},
		//[7:0]=105 PLL multiplier
		{0x3036, 0x69},
		//[4]=0 PLL root divider /1, [3:0]=5 PLL pre-divider /1.5
		...
		//[3:0] X address end high byte
		{0x3804, (1309 >> 8) & 0x0F}, //{0x3804, (2619 >> 8) & 0x0F},
		//[7:0] X address end low byte
		{0x3805, 1309 & 0xFF}, //{0x3805, 2619 & 0xFF},
		//[2:0] Y address end high byte
		{0x3806, (973 >> 8) & 0x07}, //{0x3806, (1947 >> 8) & 0x07},
		//[7:0] Y address end low byte
		{0x3807, 973 & 0xFF}, //{0x3807, 1947 & 0xFF},
	...
	config_modes_t const modes[] =
	{
			...
			{ MAP_ENUM_TO_CFG(MODE_VGA_2, cfg_VGA_2_) },
			{ MAP_ENUM_TO_CFG(MODE_VGA_3, cfg_VGA_3_) }
	};
