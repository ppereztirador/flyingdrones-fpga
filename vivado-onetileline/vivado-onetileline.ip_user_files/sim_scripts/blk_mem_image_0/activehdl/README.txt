...
#
# Generated by export_simulation on Thu Mar 10 11:51:10 CET 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_image_0.sh' script.

./blk_mem_image_0.sh -reset_run
...
./blk_mem_image_0.sh -noclean_files

For more information on the script, please type './blk_mem_image_0.sh -help'.
