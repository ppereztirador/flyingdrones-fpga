...
fileName = '/home/pperez/Escritorio/synth_checkered.hop'
image = plt.imread('/home/pperez/Imágenes/hojas1.bmp')
image2 = np.zeros((720,1280,3)).astype(int)
image2[0:480,0:640,:] = image[:,:,:]
image2[0:480,640:1280,:] = image[:,:,:]
image2[480:720,0:640,:] = image[0:240,:,:]
image2[480:720,640:1280,:] = image[0:240,:,:]
Y_image = imageFuncs.luminanceInt(image2)

#Y_image = imageFuncs.luminanceInt(image)
#Y_image = imageFuncs.generateMockupCheckered(1280,720)
